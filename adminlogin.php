...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["adminlogin"])) {
    ...
    if ($loginEmail=="srivastashriya20@gmail.com" && $loginPassword=="shreya123") {
...
// Retrieve the user's userId from the database (assuming you have a users table)
        ...
        header("Location: 'http://localhost\project\real-estate-html-template\admin\index.php'"); // Redirect to the index.php page on successful login
