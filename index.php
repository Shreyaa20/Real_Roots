        ...
        <div class="container-fluid bg-primary mb-5 wow fadeIn" data-wow-delay="0.1s" style="padding: 35px;">
            <div class="container">
                <div class="row g-2">
                    ...
                    <div class="col-md-2">
                        <button class="btn btn-dark border-0 w-100 py-3" type="submit" name="home_search">Search</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="testimonial-item bg-light rounded p-3">
                        <div class="bg-white border rounded p-4">
                            <p>"Exceptional service! Our agent went above and beyond to find us our dream home.';echo" We couldn't be happier with the";echo' result."</p>
                    ...
                    <div class="testimonial-item bg-light rounded p-3">
                        <div class="bg-white border rounded p-4">';echo'
                            <p>"The ';echo"team's expertise and professionalism made selling our property a breeze. They made the process smooth and ";echo'stress-free."</p>
                            <div class="d-flex align-items-center">
