...
// Retrieve the user's userId from the database (assuming you have a users table)
    ...
    $_SESSION["userId"] = $row["userId"]; // Set the userId session variable
        ...
        header("Location: index.php"); // Redirect to the index.php page on successful login
...
<body>
    ...
    <div class="card__back">
                ...
                <h2 style="text-align: center" class="heading-secondary">Login</h2>
                ...
                <p style="background-color: white" class="card__toggle">';echo"Don't have an account? ";echo'<span id="toggle-signup"><a href="http://localhost/project/real-estate-html-template/signup.php">Sign Up</span></p>
                <br>
                <p style="background-color: white" class="card__toggle">Are you an admin? <span id="toggle-signup"><a href="http://localhost/project/real-estate-html-template/adminlogin.php">Login</a></span></p>
